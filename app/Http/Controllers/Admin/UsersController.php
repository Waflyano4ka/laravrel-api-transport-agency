...
class UsersController extends Controller
{
    ...
    public function index(IndexUser $request)
    {
        ...
        $data = AdminListing::create(User::class)->processRequestAndGet(
            ...
            ['id', 'email', 'surname', 'first_name', 'second_name', 'passport_series', 'passport_number', 'inn', 'scan', 'birthday', 'deleted', 'dismissed', 'api_token'],

            // set columns to searchIn
            ['id', 'email', 'surname', 'first_name', 'second_name', 'passport_series', 'passport_number', 'inn', 'scan', 'api_token']
        );
